...
import 'package:flutter_app_928/utils/number_text_input_formatter.dart';
import 'package:flutter_app_928/utils/toast.dart';
import 'package:flutter_app_928/utils/utils.dart';
import 'package:flutter_app_928/widget/base_dialog.dart';
    ...
    return BaseDialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: MyUtils.isDark(context) ? Colours.dark_bg_gray_ : Colours.bg_gray,
